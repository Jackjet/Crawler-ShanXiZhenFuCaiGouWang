...
##############################################
def getLastReco():
    f = codecs.open(u'/home/admin/SXZFCGW/lastReco.txt','r+','utf-8')
    recos = f.readlines()
    f.close()
    return recos
...
def get_open_seats():
    ...
    f = codecs.open(u'/home/admin/SXZFCGW/lastReco.txt','w','utf-8')
    #是否向文件中写入了新的内容
    flag=False
    resres = ""
    page = 1
...
if __name__ == "__main__":
    try:
        ...
        if nowRecos is None or nowRecos=="":
            ...
            #sendMessage("+8618835109707","山西省政府采购网没有新消息。。。")
        else:
            print (nowRecos)
            #print('here is new records')
